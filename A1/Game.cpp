...
bool Game::Initialize()
{
	...
	mMainWndCaption = L"Luka Ivicevic's Final Assignment";
...
void Game::LoadTextures()
{
	...
	CreateTextures("EagleTex", L"Textures/Eagle.dds");
	CreateTextures("RaptorTex", L"Textures/Raptor.dds");
	CreateTextures("DesertTex", L"Textures/Desert.dds");
	CreateTextures("TitleBackgroundTex", L"Textures/Background.dds");
	CreateTextures("TitleTextTex", L"Textures/TitleText.dds");
	CreateTextures("MenuBackgroundTex", L"Textures/Background.dds");
	CreateTextures("MenuInstructionsTex", L"Textures/MenuInstructions.dds");
	CreateTextures("PauseOverlayTex", L"Textures/PauseOverlay.dds");
}
...
void Game::BuildShapeGeometry()
{
	...
	GeometryGenerator::MeshData quad = geoGen.CreateQuad(-0.5f, 0.5f, 1.f, 1.f, 0);
	...
	//Store all vertex to one big vector of vertex
...
void Game::BuildFrameResorces(int renderItemCount)
{
	for (int i = 0; i < gNumFrameResources; i++)
	{
		mFrameResources.push_back(std::make_unique<FrameResource>(md3dDevice.Get(),
...
{
	//Create Materials. HAS TO BE IN THE SAME ORDER AS THE TEXTURES!!!!!
	CreateMaterials("EagleMat", XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), XMFLOAT3(0.05f, 0.05f, 0.05f), 0.2f);
	CreateMaterials("RaptorMat", XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), XMFLOAT3(0.05f, 0.05f, 0.05f), 0.2f);
	CreateMaterials("DesertMat", XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), XMFLOAT3(0.05f, 0.05f, 0.05f), 0.2f);
